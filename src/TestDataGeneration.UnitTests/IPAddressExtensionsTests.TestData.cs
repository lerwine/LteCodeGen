    ...
    static class TestData
    {
        public static System.Collections.IEnumerable GetGetFirstAddressInBlockTest1Data()
        {
            ...
            .Returns(
                new IPAddress(new byte[]
                {
                    0xbb, 0xdf, 0xfe, 0xf7, 0xfd, 0xf7, 0xff, 0x77,
                    // 
                    0xff, 0xf5, 0xff, 0xff, 0x5d, 0xfb, 0xff, 0xfc
                    // 
                }) // bbdf:fef7:fdf7:ff77:fff5:ffff:5dfb:fffc
            );
            ...
            yield return new TestCaseData(
                new IPAddress(new byte[]
                {
                    ...
                    0b1111_1011, 0b0011_0110, 0b0101_1010, 0b1101_1101, 0b1111_1111, 0b1110_1111, 0b0000_1111, 0b0001_1101
                }), // a7df:ff7b:ed1f:befb:fb36:5add:ffef:f1d
                (byte)126
            )
            .Returns(
                new IPAddress(new byte[]
            ...
            .Returns(
                new IPAddress(new byte[]
                {
                    0x86, 0xff, 0x34, 0x28, 0x12, 0xae, 0x33, 0x8d, 0xd8, 0x58, 0x94, 0x3a, 0x58, 0xeb, 0x08, 0x98
                }) // 86ff:3428:12ae:338d:d858:943a:58eb:898
            );
            ...
            .Returns(
                new IPAddress(new byte[]
                {
                    0x4c, 0xae, 0x24, 0xd8, 0x40, 0x50, 0xad, 0xe3, 0x28, 0x59, 0xba, 0xd1, 0x92, 0x20, 0x36, 0xec
                }) // 4cae:24d8:4050:ade3:2859:bad1:9220:36ec
            );
        ...
        public static System.Collections.IEnumerable GetGetLastAddressInBlockTest1Data()
        {
            ...
            .Returns(
                new IPAddress(new byte[]
                {
                    0xcd, 0xff, 0xde, 0xf7, 0xff, 0xff, 0xdb, 0x7f, 0xef, 0xfe, 0x2f, 0x8e, 0x77, 0x8f, 0xe1, 0x17
                }) // cdff:def7:ffff:db7f:effe:2f8e:778f:e117
            );

            yield return new TestCaseData(
                new IPAddress(new byte[]
                {
                    0xc8, 0xbf, 0xda, 0x66, 0xf6, 0x5e, 0xc3, 0x6f, 0x6f, 0xc4, 0x2b, 0x8e, 0x74, 0x00, 0xa1, 0x10
                }), // c8bf:da66:f65e:c36f:6fc4:2b8e:7400:a110
                (byte)126
            )
            .Returns(
                new IPAddress(new byte[]
                {
                    0xc8, 0xbf, 0xda, 0x66, 0xf6, 0x5e, 0xc3, 0x6f, 0x6f, 0xc4, 0x2b, 0x8e, 0x74, 0x00, 0xa1, 0x13
            ...
            yield return new TestCaseData(
                new IPAddress(new byte[]
                {
                    0xfb, 0xdd, 0x4e, 0xce, 0xc4, 0xc7, 0x54, 0xbf, 0x99, 0xb3, 0xd0, 0x76, 0x30, 0xa7, 0xb4, 0x68
                }), // fbdd:4ece:c4c7:54bf:99b3:d076:30a7:b468
                (byte)126
            )
            .Returns(
                new IPAddress(new byte[]
                {
                    0xfb, 0xdd, 0x4e, 0xce, 0xc4, 0xc7, 0x54, 0xbf, 0x99, 0xb3, 0xd0, 0x76, 0x30, 0xa7, 0xb4, 0x6b
                }) // fbdd:4ece:c4c7:54bf:99b3:d076:30a7:b46b
            );

            yield return new TestCaseData(
                new IPAddress(new byte[]
                {
                    0x28, 0x8a, 0x5a, 0x4e, 0x66, 0xa0, 0x86, 0x4a, 0x0c, 0xac, 0xf6, 0xee, 0x70, 0x53, 0x03, 0xfa
                }), // 288a:5a4e:66a0:864a:0cac:f6ee:7053:03fa
                (byte)126
            )
            .Returns(
                new IPAddress(new byte[]
                {
                    0b0010_1000, 0b1000_1010, 0x5a, 0x4e, 0x66, 0xa0, 0x86, 0x4a, 0x0c, 0xac, 0xf6, 0xee, 0x70, 0x53, 0x03, 0xfb
                }) // 288a:5a4e:66a0:864a:cac:f6ee:7053:3fb
            );

            yield return new TestCaseData(
                new IPAddress(new byte[]
                {
                    0xf0, 0x9f, 0x8c, 0xa2, 0x54, 0xf9, 0x33, 0x7d, 0x7b, 0xde, 0xd3, 0xc9, 0xe4, 0x10, 0xb0, 0xdc
                }), // f09f:8ca2:54f9:337d:7bde:d3c9:e410:b0dc
                (byte)126
            )
            .Returns(
                new IPAddress(new byte[]
                {
                    0xf0, 0x9f, 0x8c, 0xa2, 0x54, 0xf9, 0x33, 0x7d, 0x7b, 0xde, 0xd3, 0xc9, 0xe4, 0x10, 0xb0, 0xdf
