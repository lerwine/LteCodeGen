...
public sealed class DelegatedRandomCharSource : RandomCharacterSource
{
    ...
    public DelegatedRandomCharSource(CharacterType type, Collection<RandomCharacterSource> includes, Collection<RandomCharacterSource> includedBy, Predicate<char> test, Func<IEnumerable<char>> getValues) : base(type, includes, includedBy)
    {
        _test = test;
