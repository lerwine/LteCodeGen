...
public readonly struct UnsignedMixedFraction96 : IMixedFraction<UnsignedMixedFraction96, uint, UnsignedFraction64>
{
    ...
    /// <exception cref="OverflowException"><paramref name="s"/> is not representable by a <see cref="UnsignedMixedFraction96"/>.</exception>
    ...
    /// <summary>
    /// Parses a string into a <see cref="UnsignedMixedFraction96"/> value.
    /// </summary>
