...
public readonly struct UnsignedMixedFraction48 : IMixedFraction<UnsignedMixedFraction48, ushort, UnsignedFraction32>
{
    ...
    /// <exception cref="OverflowException"><paramref name="s"/> is not representable by a <see cref="UnsignedMixedFraction48"/>.</exception>
    ...
    /// <summary>
    /// Parses a string into a <see cref="UnsignedMixedFraction48"/> value.
    /// </summary>
