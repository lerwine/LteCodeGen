...
public readonly struct MixedFraction192 : IMixedSignedFraction<MixedFraction192, long, Fraction128>
{
    ...
    /// <exception cref="OverflowException"><paramref name="s"/> is not representable by a <see cref="MixedFraction192"/>.</exception>
    ...
    /// <summary>
    /// Parses a string into a <see cref="MixedFraction192"/> value.
    /// </summary>
