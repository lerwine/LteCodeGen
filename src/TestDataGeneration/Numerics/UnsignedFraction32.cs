...
public readonly struct UnsignedFraction32 : ISimpleFraction<UnsignedFraction32, ushort, UnsignedMixedFraction48>
{
    ...
    /// <exception cref="OverflowException"><paramref name="s"/> is not representable by a <see cref="UnsignedFraction32"/>.</exception>
    ...
    /// <summary>
    /// Parses a string into a <see cref="UnsignedFraction32"/> value.
    /// </summary>
