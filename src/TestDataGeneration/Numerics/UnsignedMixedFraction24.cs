...
/// <summary>
/// 24-bit unsigned, mixed fractional value comprised of 8-bit whole number, numerator and denominator values.
/// </summary>
public readonly struct UnsignedMixedFraction24 : IMixedFraction<UnsignedMixedFraction24, byte, UnsignedFraction16>
{
    ...
    /// <summary>
    /// Creates a <c>UnsignedMixedFraction24</c> fraction value.
    /// </summary>
    ...
    /// <summary>
    /// Creates a <c>UnsignedMixedFraction24</c> fraction value with a whole number of <c>0</c>.
    /// </summary>
    /// <param name="numerator">The numerator value.</param>
    /// <param name="denominator">The denominator value.</param>
    /// <param name="doNotReduce">If true, the fraction value will not be reduced to its simplest terms.</param>
    ...
    /// <summary>
    /// Creates a <c>UnsignedMixedFraction24</c> whole number fraction value with a numerator of <c>0</c> and denominator of <c>1</c>.
    /// </summary>
    /// <param name="wholeNumber">The whole number value.</param>
    ...
    /// <exception cref="OverflowException"><paramref name="s"/> is not representable by a <see cref="UnsignedMixedFraction24"/>.</exception>
    ...
    /// <summary>
    /// Parses a string into a <see cref="UnsignedMixedFraction24"/> value.
    /// </summary>
    ...
    /// <exception cref="ArgumentException"><paramref name="style"/> is not a supported <see cref="NumberStyles"/> value.</exception>
    public static bool TryParse(ReadOnlySpan<char> s, NumberStyles style, IFormatProvider? provider, out UnsignedMixedFraction24 result)
    {
    ...
    /// <returns><see langword="true"/> if <paramref name="s"/> was successfully parsed; otherwise, <see langword="false"/>.</returns>
    /// <exception cref="ArgumentException"><paramref name="style"/> is not a supported <see cref="NumberStyles"/> value.</exception>
    public static bool TryParse([NotNullWhen(true)] string? s, NumberStyles style, IFormatProvider? provider, out UnsignedMixedFraction24 result)
    {
    ...
    /// <param name="result">On return, contains the result of succesfully parsing <paramref name="s"/>.</param>
    /// <returns><see langword="true"/> if <paramref name="s"/> was successfully parsed; otherwise, <see langword="false"/>.</returns>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out UnsignedMixedFraction24 result)
    {
    ...
    /// <param name="result">On return, contains the result of succesfully parsing <paramref name="s"/>.</param>
    /// <returns><see langword="true"/> if <paramref name="s"/> was successfully parsed; otherwise, <see langword="false"/>.</returns>
    public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, out UnsignedMixedFraction24 result)
    {
    ...
    static bool INumberBase<UnsignedMixedFraction24>.IsCanonical(UnsignedMixedFraction24 value) => true;

    static bool INumberBase<UnsignedMixedFraction24>.IsComplexNumber(UnsignedMixedFraction24 value) => false;

    static bool INumberBase<UnsignedMixedFraction24>.IsFinite(UnsignedMixedFraction24 value) => true;

    static bool INumberBase<UnsignedMixedFraction24>.IsImaginaryNumber(UnsignedMixedFraction24 value) => false;

    static bool INumberBase<UnsignedMixedFraction24>.IsInfinity(UnsignedMixedFraction24 value) => false;

    static bool INumberBase<UnsignedMixedFraction24>.IsNegative(UnsignedMixedFraction24 value) => false;

    static bool INumberBase<UnsignedMixedFraction24>.IsNegativeInfinity(UnsignedMixedFraction24 value) => false;

    static bool INumberBase<UnsignedMixedFraction24>.IsNormal(UnsignedMixedFraction24 value) => true;

    static bool INumberBase<UnsignedMixedFraction24>.IsPositive(UnsignedMixedFraction24 value) => true;

    static bool INumberBase<UnsignedMixedFraction24>.IsPositiveInfinity(UnsignedMixedFraction24 value) => false;

    static bool INumberBase<UnsignedMixedFraction24>.IsRealNumber(UnsignedMixedFraction24 value) => value.Denominator != 0;

    static bool INumberBase<UnsignedMixedFraction24>.IsSubnormal(UnsignedMixedFraction24 value) => false;
