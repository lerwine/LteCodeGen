...
public readonly struct MixedFraction96 : IMixedSignedFraction<MixedFraction96, int, Fraction64>
{
    ...
    /// <exception cref="OverflowException"><paramref name="s"/> is not representable by a <see cref="MixedFraction96"/>.</exception>
    ...
    /// <summary>
    /// Parses a string into a <see cref="MixedFraction96"/> value.
    /// </summary>
